...
// 🏙️ CITY - Asfalt zemin
        ...
        private void drawPowerUps(Graphics g) {
            for (PowerUp powerUp : powerUps) {
                ...
                if (powerUp instanceof SpeedBoostPowerUp) {
                    ...
                    drawStar(g, screenX + CELL_SIZE / 2, screenY + CELL_SIZE / 2, 15, color, "👻");
                } else if (powerUp instanceof MaxSpeedPowerUp) {
                    Color color = new Color(255, (int) (215 * brightness), 0);
                    drawStar(g, screenX + CELL_SIZE / 2, screenY + CELL_SIZE / 2, 15, color, "🚀");
                }
            }
        }
        ...
        private void drawPlayers(Graphics g) {
            for (int i = 0; i < players.size(); i++) {
                ...
                // Player rengi
                if (i == 0) {
                    g.setColor(Color.BLUE); // Player 1
                } else {
                    g.setColor(Color.RED); // Player 2
                }
                ...
                g.drawOval(screenX + 10, screenY + 10, CELL_SIZE - 20, CELL_SIZE - 20);

                // Oyuncu numarası
                g.setColor(Color.WHITE);
                g.setFont(new Font("Arial", Font.BOLD, 20));
                g.drawString("P" + (i + 1), screenX + 18, screenY + 33);
            }
        }
        ...
        private void drawEnemies(Graphics g) {
            for (Enemy enemy : enemies) {
                ...
                g.fillRect(screenX + 10, screenY + 10, CELL_SIZE - 20, CELL_SIZE - 20);

                g.setColor(Color.BLACK);
                g.drawRect(screenX + 10, screenY + 10, CELL_SIZE - 20, CELL_SIZE - 20);
            }
        }
